...
public class SetupActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if( savedInstanceState != null && savedInstanceState.containsKey(KEY_SETTINGS)) {
		...
		fragmentSettings.setArguments(SetupSettingsFragment.createArguments(settings));
		Fragment fragmentTeam1 = new SetupTeamFragment();
		fragmentTeam1.setArguments(SetupTeamFragment.createArguments(settings.getTeam1())); 
		Fragment fragmentTeam2 = new SetupTeamFragment();
		fragmentTeam2.setArguments(SetupTeamFragment.createArguments(settings.getTeam2()));
